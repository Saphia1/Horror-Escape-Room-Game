...
class Cell(PygameUtil):
    ...
    def getwalledge(self):#A dictionary of the edges of each wall
        walledges={
                "top":[(self.__x,self.__y),(self.__x+self._WIDTH,self.__y)],
                    
                "bottom":[(self.__x+self._WIDTH,self.__y+self.__height), (self.__x,self.__y+self.__height)],

                "left":[(self.__x,self.__y+self.__height),(self.__x,self.__y)],
